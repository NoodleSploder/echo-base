...
registerDecoder({
  ...
  bands: [
    { minHz: 145_790_000, maxHz: 145_810_000, label: "2m FM (145.800MHz, ISS SSTV events)" },
    { minHz: 14_225_000, maxHz: 14_235_000, label: "20m SSTV (14.230MHz)" },
    { minHz: 7_166_000, maxHz: 7_176_000, label: "40m SSTV (7.171MHz)" },
    { minHz: 3_840_000, maxHz: 3_850_000, label: "80m SSTV (3.845MHz)" },
  ],
